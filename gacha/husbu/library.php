                ...
                <tbody>
                    <?php 
                        ...
                        while($row = $result->fetch_assoc()){
                            ...
                            $owned_query = "SELECT * FROM user_characters WHERE user_id = ".$_SESSION['id']." AND character_id = ".$row['id'];
                            ...
                            <td><img src="../husbuimages/'.$rarity.'/'.$row['image'].'" height=150 width=150 '.$color.'></td>
                        </tr>';
                        }
                    ?>
                </tbody>
